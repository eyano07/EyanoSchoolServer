...
public class PaymentRegistrationMapper implements Mapper<PaymentRegistrationDto, PaymentRegistration> {
    ...
    /**
     * Convert a list of PaymentRegistrationDto to a list of PaymentRegistration entities
     * @param paymentRegistrationDtos : List of PaymentRegistration entities
     * @return List of PaymentRegistration
     */
    @Override
    public List<PaymentRegistration> dtosFromEntities(List<PaymentRegistrationDto> paymentRegistrationDtos) {
        List<PaymentRegistration> paymentRegistrationList = new ArrayList<>();
        for (PaymentRegistrationDto paymentRegistrationDto : paymentRegistrationDtos) {
            paymentRegistrationList.add(dtoFromEntity(paymentRegistrationDto));
        }
        return paymentRegistrationList;
    }
    /**
