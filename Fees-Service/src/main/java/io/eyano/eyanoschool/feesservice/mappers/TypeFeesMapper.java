...
public class TypeFeesMapper implements Mapper<TypeFeesDto, TypeFees> {
    ...
    /**
     * Convert a list of TypeFeesDto to a list of TypeFees entities
     * @param typeFeesDtos : List of TypeFees entities
     * @return List of TypeFees
     */
    @Override
    public List<TypeFees> dtosFromEntities(List<TypeFeesDto> typeFeesDtos) {
        List<TypeFees> typeFeesList = new ArrayList<>();
        for (TypeFeesDto typeFeesDto : typeFeesDtos) {
            TypeFees typeFees = dtoFromEntity(typeFeesDto);
            typeFeesList.add(typeFees);
        }
        return typeFeesList;
    }
    /**
