...
public class FeesAllocationMapper implements Mapper<FeesAllocationDto, FeesAllocation> {
    ...
    /**
     * Convert a list of FeesAllocationDto to a list of FeesAllocation entities
     * @param feesAllocationDtos : List of FeesAllocation entities
     * @return List of FeesAllocation entities
     */
    @Override
    public List<FeesAllocation> dtosFromEntities(List<FeesAllocationDto> feesAllocationDtos) {

        List<FeesAllocation> feesAllocations = new ArrayList<>();
        for (FeesAllocationDto feesAllocationDto : feesAllocationDtos) {
            FeesAllocation feesAllocation =  dtoFromEntity(feesAllocationDto);
            feesAllocations.add(feesAllocation);
        }

        return feesAllocations;
    }
    /**
